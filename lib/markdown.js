...
this.Markdown = function(text, stripUnwanted, allowedTags, allowedAttributes, forceProtocol){
    var md = text;
	if (stripUnwanted) md = stripUnwantedHTML(md, allowedTags, allowedAttributes, forceProtocol);
	md =  Showdown.makeHtml(text);
	return md;
}
 ...
 **/
var stripUnwantedHTML = function(html /*, allowedTags, allowedAttributes, forceProtocol, escapeTags */){
    var allowedTags = arguments[1] || 
        ...
        allowedAttributes = arguments[2] || {
            ...
            'a':   'href',
            '*':   'title'
        }, forceProtocol = arguments[3] || false, escapeTags = arguments[4] || false;
